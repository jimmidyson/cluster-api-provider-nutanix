...
func Convert_v1alpha4_NutanixMachineSpec_To_v1beta1_NutanixMachineSpec(
	in *NutanixMachineSpec,
	out *infrav1beta1.NutanixMachineSpec,
...
func Convert_v1beta1_NutanixMachineSpec_To_v1alpha4_NutanixMachineSpec(
	in *infrav1beta1.NutanixMachineSpec,
	out *NutanixMachineSpec,
	s apiconversion.Scope,
) error {
	// Wrapping the conversion function to avoid compilation errors due to compileErrorOnMissingConversion()
	// Ref: https://github.com/kubernetes/kubernetes/issues/98380
...
func Convert_v1alpha4_NutanixMachineStatus_To_v1beta1_NutanixMachineStatus(
	in *NutanixMachineStatus,
	out *infrav1beta1.NutanixMachineStatus,
	s apiconversion.Scope,
) error {
	// Wrapping the conversion function to avoid compilation errors due to compileErrorOnMissingConversion()
	// Ref: https://github.com/kubernetes/kubernetes/issues/98380
